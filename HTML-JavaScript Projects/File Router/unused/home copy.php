...
<script>
    ...
    function selectTab(section) {
        ...
        document.getElementById("my_assignments_section").style.display = "none";
        document.getElementById("my_requests_section").style.display = "none";
        document.getElementById("all_requests_section").style.display = "none";
        ...
        document.getElementById(section + "_section").style.display = "unset";
...
<body>
    ...
    <div class="main">
        ...
        <div id="my_assignments_section" style="display: none">
        ...
        <div id="my_requests_section" style="display: none">
        ...
        <div id="all_requests_section" style="display: none">
...
<script>
    ...
    $tab = $_SESSION["requests_tab"] . "_button";
    $section = $_SESSION["requests_tab"] . "_section";

    ?>

    document.getElementById("<?php echo $tab ?>").style.backgroundColor = "rgb(16, 48, 80)";
    document.getElementById("<?php echo $section ?>").style.display = "unset";
